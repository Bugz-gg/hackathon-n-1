...
label_title = Label(master, text="Discussions", font=("Helvetica", 40), bg='#41B77F', fg='black')
label_title.pack(side="top")

label_title = Label(master, text="Statistiques", font=("Helvetica", 40), bg='#41B77F', fg='black')
label_title.pack(side="top")

label_title = Label(master, text="Règlages", font=("Helvetica", 40), bg='#41B77F', fg='black')
label_title.pack(side="top")

label_title = Label(master, text="Présentartion", font=("Helvetica", 40), bg='#41B77F', fg='black')
label_title.pack(side="top")
